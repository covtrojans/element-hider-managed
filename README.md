...
Here is what it would look like to combine the last two examples. Be sure the arrays are organized correctly so the script knows what URL corrisponds to each query.
```
{
	"urlList": {
		"Value": [
